...
class DriverProfileRepository extends BaseRepository
{
    ...
    public function updateVehicleInfo(String $token, array $request)
    {
        ...
        if ($driver) {
            //iniciando chamada de repositórios
            $vehicle_repo = new VehicleRepository(new Vehicle());

            //atualizando dados do veículo
            return $vehicle_repo->updateVehicle($driver->vehicle_id, $request);
        } else
            return 'Motorista inexistente ou não localizado';
    }
